...
<body>
    ...
    <a class="active"href="reservation.html">Online Reservation</a>
...
echo "<h1> Available Flights from '{$d}' to '{$a}'</h1>";
$date=$_POST['DATE'];
$_SESSION['jdate']=$date; 
$fr='';
$fn='';
$query = "SELECT * from flight where origin ='{$d}' and destination='{$a}' ";
