...
<body>
    ...
    <a class="active" href="FlightStatus.html">Flight Status</a>
...
$enum=$_POST['eticket'];
$query = "SELECT * from flight_status where E_TICKET_NUMBER={$enum}";
	  if ($result = mysqli_query($link, $query)) {
		  /* fetch associative array */
    while ($row = mysqli_fetch_row($result)) {
        
    echo "<h1 style='text-align:center;'>--------FLIGHT STATUS---------</h1>";
	echo"<td class='c3'>";
	echo $row[6];
	echo"</td>";
	echo"<td class='c4'>";
